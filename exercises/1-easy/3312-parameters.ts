...
/*
  NOTES
  - First, cast the type to a function, with any arguments spead as any[]
  - We use `any[]` to handle functions with no arguments
  - Then, extract the argument types using `infer` and pass then back
*/

type MyParameters<Function extends (...args: any[]) => any> = Function extends (
  ...args: infer Parameter
) => any
  ? Parameter
  : never;
